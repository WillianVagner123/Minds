-- Este arquivo consolida o esquema do Supabase utilizado pelo PINGO/MINDS.
-- Ele define todas as tabelas e views necessárias para armazenar os cadastros
-- dos atletas, análises de instrumentos psicométricos, cargas de treino,
-- avaliações semanais e flags de risco.  Pode ser importado diretamente
